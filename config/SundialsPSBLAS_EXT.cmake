...
IF(PSBLAS_EXT_DISABLED)
  SET(PSBLAS_EXT_DISABLED FALSE CACHE INTERNAL "GUI - now enabled" FORCE)
  RETURN()
ENDIF()

SET(PSBLAS_EXT_FOUND FALSE)

# set PSBLAS_LIBRARIES
include(FindPSBLAS_EXT)

SET(PSBLAS_EXT_FOUND TRUE)
